...
class Niveau10 extends StatefulWidget {
  const Niveau10({
    super.key,
  });

  @override
  State<Niveau10> createState() => _Niveau10State();
}

class _Niveau10State extends State<Niveau10> {
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                      right: 63,
                      top: 100,
                      child: Or(controller: orController2)),
                  //les portes not
                  Positioned(
                      left: 5,
                      bottom: 270,
                  ...
                  Positioned(
                    ...
                    right: 143,
                    child: LienVertical(
                        lienState: interrupteur2State, height: 210),
                  ),
                  Positioned(
                    top: 400,
                    child: LienHorizontal(
                        lienState: interrupteur2State, width: 70),
                  ),
                  // input left not
                  Positioned(
                    top: 350,
                    left: 65,
                    child: LienVertical(
                        lienState: interrupteur1State, height: 130),
                  ),
                  // input center not
                  Positioned(
                    top: 350,
                    right: 210,
                    child: LienVertical(
                        lienState: interrupteur2State, height: 130),
                  ),
                  // input right not
                  Positioned(
                    top: 350,
                    right: 103,
                    child: LienVertical(
                        lienState: interrupteur3State, height: 130),
                  ),
                  //Les interrupteurs
                  Positioned(
                    bottom: 115,
